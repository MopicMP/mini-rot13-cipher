...
> Mini rot13 and caesar cipher with n shifts

[![PyPI version](https://badge.fury.io/py/mini-rot13-cipher.svg)](https://pypi.org/project/mini-rot13-cipher/)
...
```bash
pip install mini-rot13-cipher
```

## Quick Start

```python
from mini_rot13_cipher import cipher

# Basic usage
result = cipher("your input here")
print(result)
```
...
result = cipher("Hello World")

# Example 2: Batch processing
from mini_rot13_cipher import batch
